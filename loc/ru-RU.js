...
var stations_ru_RU = [
    {
        ...
        requirements: {
            items: [
                [10000, "Доллары"],
                [2, "Воздушный фильтр для противогаза"],
                [1, "Военный фильтр питания"]
            ],
            loyalty: [["Лыжник", "LL3"]]
        }
    },
    ...
    },
    {
        ...
        requirements: {
            items: [
                ...
                [3, "Пачка соды"],
                [2, "Средство для прочистки труб Копченый Дымоход"]
            ],
            skills: [["Метаболизм", 3]]
        }
    },
    ...
    },
    {
        ...
        requirements: {
            items: [
                [4, "Бронзовый лев"],
                [6, "Золотое кольцо с черепом"],
                [8, "Золотая цепочка"],
                [4, "Золотые часы Roler Submariner"]
            ]
        }
    },
    {
    ...
    },
    {
        ...
        requirements: {
            items: [
                [25000, "Евро"],
                [8, "Военный кабель"],
                [4, "Элемент фазированной решетки РЛС"],
                [8, "Военный фильтр питания"]
            ],
